// features/education/teachers/types/teacherType.ts
...
export type CreateTeacherDto = TeacherCreateBase & {
...
export interface TeacherFilters {
  ...
  /** Person-derived filters (JOIN via personTeacherId) */
  genderId?: string;
