...
const TeacherDetailsModal = memo(({ open, onClose, teacher }: TeacherDetailsModalProps) => {
  ...
  const yearsOfExperience = teacher.yearsOfExperience ?? 0;

  const qualifs = teacher.educationalQualifications ?? [];
  const experiences = teacher.professionalExperience ?? [];
  const refs = teacher.references ?? [];
                ...
                <Grid container spacing={2}>
                  <Grid size={{ xs: 12, md: 4 }}>
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                      {getEntityNames(subjects, teacher.subjectIds).map((name, i) => (
                  ...
                  <Grid size={{ xs: 12, md: 4 }}>
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                      {getEntityNames(gradeLevels, teacher.gradeLevelIds).map((name, i) => (
                  ...
                  <Grid size={{ xs: 12, md: 4 }}>
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                      {getEntityNames(languageProficiencies, teacher.languageProficiencyIds).map((name, i) => (
                ...
                <List dense>
                  <ListItem>
                    <ListItemText
                      ...
                      secondary={
                        teacher.salaryExpectation != null
                          ? `৳${Number(teacher.salaryExpectation).toLocaleString()}`
                          : 'Not specified'
                      }
                    />
                  </ListItem>
                  ...
                  <ListItem>
                    <ListItemText primary="Notice Period" secondary={teacher.noticePeriod || 'Not specified'} />
                  </ListItem>
                </List>
              </CardContent>
            </Card>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Card variant="outlined">
              <CardContent>
                ...
                <List dense>
                  <ListItem>
                    <ListItemText primary="Computer Skills" secondary={teacher.computerSkills || 'Not specified'} />
                  </ListItem>
                  <ListItem>
                    <ListItemText
                  ...
                  {teacher.onlineProfiles?.linkedin && (
                    <ListItem>
                      <ListItemText primary="LinkedIn" secondary={teacher.onlineProfiles.linkedin} />
                    </ListItem>
                  )}
                  {teacher.onlineProfiles?.personalWebsite && (
                    <ListItem>
                      <ListItemText primary="Personal Website" secondary={teacher.onlineProfiles.personalWebsite} />
                    </ListItem>
                  )}
                </List>
              </CardContent>
            ...
            <Grid size={{ xs: 12 }}>
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography variant="body2">{teacher.details}</Typography>
                </CardContent>
              </Card>
            </Grid>
          )}
