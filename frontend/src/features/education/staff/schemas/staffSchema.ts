// features/education/staff/schemas/staffSchema.ts
import { z } from 'zod';
...
/** ========= Main schema (Staff create/update form) =========
 *  👉 Person-এর তথ্য আলাদা এন্টিটিতে, এখানে শুধু FK + staff-specific ফিল্ডগুলো
 *  👉 types/api অনুযায়ী educationalQualifications বাধ্যতামূলক (>=1)
 */
export const staffSchema = z.object({
  /** FK to Person (must be a STAFF person) */
  personStaffId: z.string().min(1, 'Staff person is required'),
